...
A command-line tool that can send and recieve (Blowfish) encrypted frames/packets across networks using [Scapy](https://github.com/secdev/scapy) and [Python Cryptography Toolkit](https://github.com/pycrypto/pycrypto).
